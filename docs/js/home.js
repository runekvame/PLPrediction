...
async function loadPage() {
    ...
    document.getElementById('upcoming-matches').innerHTML = renderUpcomingMatches(matches);
    document.getElementById('recent-matches').innerHTML = renderRecentMatches(matches);

    const leaderboard = await getLeaderboard();
    document.getElementById('mini-leaderboard').innerHTML = renderMiniLeaderboard(leaderboard);
}
